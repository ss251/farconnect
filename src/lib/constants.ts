 ...
 */
export const APP_DESCRIPTION: string = 'A farcaster mini app that lets devconnect attendees connect with each other.';
 ...
 */
export const APP_TAGS: string[] = ['social', 'chat', 'connect', 'group'];
